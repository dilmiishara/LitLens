  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <BackButton />
        <h1 className="text-3xl my-4 text-white">Edit Review</h1>
        {loading && <Spinner />} {/* Show spinner when loading */}
        {error && <div className="text-red-500 my-2">{error}</div>} {/* Display error */}
        <div className="flex flex-col border-2 border-white rounded-xl w-[600px] p-4 mx-auto bg-white bg-opacity-70">
          ...
          <button className="p-2 bg-black m-8" onClick={handleEditBook}>
            Save
          </button>
        </div>
      </div>
